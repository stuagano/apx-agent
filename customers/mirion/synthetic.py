"""Synthetic data for all four Mirion sources (SFDC, ServiceMax, SharePoint, SAP).
...
_PRODUCTS = [
    "SmartID dosimeter", "SPIR-Ident spectrometer", "AccuRad PRD",
    "RDS-31 survey meter", "iPIX gamma camera", "Telepole probe",
]
