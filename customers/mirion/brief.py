...
Config-driven (``customers/mirion.toml``): for each ``[[precall.section]]`` it
...
# customers/mirion/brief.py -> customers/mirion.toml
_CONFIG = Path(__file__).resolve().parent.parent / "mirion.toml"
