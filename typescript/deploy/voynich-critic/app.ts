...
const agentPlugin = createAgentPlugin({
  ...
  instructions: [
    ...
    'Call the find_contradictions tool and use the adversarial score it returns.',
    '',
    'Respond with ONLY a JSON object containing the score from the tool:',
    '  { "adversarial": <0-1> }',
    '',
    'adversarial: the score returned by find_contradictions (1=no contradictions, 0=definitely falsified)',
    '',
