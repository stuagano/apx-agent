...
apx-agent governance violations --hours 24       # recent reject/redact decisions from the UC table
apx-agent governance status --agent customer_triage  # session posture via Guardrails get_agent_compliance
