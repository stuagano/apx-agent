...
> Tip: use underscore/snake_case for `samples-healthverity` — Databricks bundle
> resource references like `${resources.experiments.samples-healthverity_experiment.id}`
