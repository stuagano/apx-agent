...
> Tip: use underscore/snake_case for `samples-bakehouse` — Databricks bundle
> resource references like `${resources.experiments.samples-bakehouse_experiment.id}`
