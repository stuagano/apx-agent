...
> Tip: use underscore/snake_case for `samples-accuweather` — Databricks bundle
> resource references like `${resources.experiments.samples-accuweather_experiment.id}`
