...
def create_shortage_pipeline() -> SequentialAgent:
    ...
    market_agent = Agent(
        instructions=(
            ...
            "The tool returns sources and snippets only — you synthesize the "
            "verdict. From the evidence, decide CONFIRMED or UNCONFIRMED and a "
...
agent = create_shortage_pipeline()
