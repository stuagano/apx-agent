"""quickstart — one-shot setup for the entity-resolution-agent Apps deploy.
...
def main() -> None:
    ...
    path, exp_id = init_apps_experiment(agent_name="entity-resolution-agent", env_path=str(env_path))
