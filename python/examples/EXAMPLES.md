...
| [trace-feedback-adapter](./trace-feedback-adapter/) | Connects an existing review backend to an APX app's authenticated trace-feedback endpoint, including feature filters, stable replay keys, and external screenshot metadata. |
