...
def _find_config() -> Path:
    # ADK shape: agent.config.yaml lives next to this file at the project root.
    # Apps deploy stages it into .build/ alongside the other top-level files.
    candidates: list[Path] = [
        Path(__file__).resolve().parent / "agent.config.yaml",
