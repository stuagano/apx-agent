...
> Tip: use underscore/snake_case for `samples-tpcds-sf1000` — Databricks bundle
> resource references like `${resources.experiments.samples-tpcds-sf1000_experiment.id}`
