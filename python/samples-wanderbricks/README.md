...
> Tip: use underscore/snake_case for `samples-wanderbricks` — Databricks bundle
> resource references like `${resources.experiments.samples-wanderbricks_experiment.id}`
