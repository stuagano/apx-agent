...
> Tip: use underscore/snake_case for `samples-tpcds-sf1` — Databricks bundle
> resource references like `${resources.experiments.samples-tpcds-sf1_experiment.id}`
